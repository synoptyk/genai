            ...
            <section>
              ...
              {openSections.seguimiento && (
                <ExpandedSection color="emerald">
                  ...
                  {(hasSubAccess('dist_mis_conductores') || hasSubAccess('dist_conecta_gps') || hasSubAccess('dist_historial_rutas') || hasSubAccess('dist_rutas_guiadas')) && (
                    <SubModule label="Distribución" icon={ArrowRightLeft} isOpen={openSections.industriaDistribucion} onToggle={() => toggle('industriaDistribucion')} accent="indigo">
                      ...
                      {hasSubAccess('dist_rutas_guiadas') && <MenuLink path="/industria/distribucion/rutas-guiadas" icon={Route} label="Rutas Guiadas" accent="indigo" isActive={isActive('/industria/distribucion/rutas-guiadas')} />}
                    </SubModule>
                  )}
