...
router.route('/')
    .get(authorize('system_admin', 'ceo', 'admin_empresas_activas'), empresaController.getEmpresas)
    .post(authorize('system_admin', 'ceo', 'admin_empresas_activas:crear'), empresaController.createEmpresa);
...
router.route('/:id')
    .get(authorize('system_admin', 'ceo', 'admin_empresas_activas'), empresaController.getEmpresaById)
    .put(authorize('system_admin', 'ceo', 'admin_empresas_activas:editar'), empresaController.updateEmpresa)
    .delete(authorize('system_admin', 'ceo', 'admin_empresas_activas:eliminar'), empresaController.deleteEmpresa);
